  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-card overflow-hidden">
        <div className="h-1" style={{ background: 'linear-gradient(90deg,#0a0f2e,#f97316,#f43f5e)' }} />
        <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
          <History size={16} style={{ color: '#f43f5e' }} />
        ...
        {loading ? (
          <div className="py-16 text-center">
            <div className="w-8 h-8 mx-auto border-2 border-t-brand-rose border-transparent rounded-full animate-spin mb-3" style={{ borderTopColor: '#f43f5e' }} />
          ...
          <div className="py-20 text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-3xl flex items-center justify-center"
              ...
              <GitBranch size={28} style={{ color: 'rgba(244,63,94,0.4)' }} />
            </div>
            ...
            {!search && (
              <button type="button" onClick={() => navigate('/pipeline')}
                ...
                style={{ background: 'linear-gradient(135deg,#0a0f2e,#f97316,#f43f5e)', boxShadow: '0 4px 16px rgba(244,63,94,0.35)' }}>
                → Lancer un pipeline
              </button>
            )}
          </div>
            ...
            {filtered.map(story => (
              <li key={story.id}
                ...
                <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                  ...
                  <GitBranch size={16} style={{ color: '#f43f5e' }} />
                </div>
