...
def test_pipeline_request_defaults_use_requested_models_and_legacy_rag():
    ...
    assert request.model_agent3_quality == "llama4"
    assert request.model_agent5 == "llama4"
...
def test_settings_defaults_match_requested_models():
    ...
    assert settings.AGENT3_QUALITY_MODEL == "llama4"
    assert settings.AGENT5_DEFAULT_MODEL == "llama4"
