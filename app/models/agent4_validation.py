"""Modèles Pydantic pour les réponses Agent 4 (validateur pur)."""
...
class DuplicatePairReport(BaseModel):
    """Paire de tests sémantiquement redondants (aucun test n'est supprimé côté Agent 4)."""
...
class Agent4ValidationReport(BaseModel):
...
class Agent4ValidationResult(BaseModel):
    story_id: str
    tests: List[ManualTestCase]
    report: Agent4ValidationReport


class Agent4StoryDashboard(BaseModel):
