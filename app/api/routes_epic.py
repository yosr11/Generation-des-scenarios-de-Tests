...
from app.services.epic_service import get_epics, get_stories_by_epic,  count_stories_by_epic, count_epics, get_stories_by_epic_detailed, _session, JIRA_BASE_URL
...
@router.get("/debug")
def debug_epics(project_key: str = Query(..., description="Clé du projet Jira (ex: YOUQA)")):
    """
...
@router.get("/count")
def epic_count(project_key: str = Query(..., description="Clé du projet Jira (ex: YOUQA)")):
    """
...
def list_epics(project_key: str = Query(..., description="Clé du projet Jira (ex: YOUQA)")):
    """
