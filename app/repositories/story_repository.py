...
def save_story(story: Dict[str, Any]) -> str:
    ...
    try:
        obj = Story(
            ...
            description_raw=story.get("description_raw", ""),
            description_clean=story.get("description_clean", ""),
            description_llm=story.get("description_llm", ""),
            acceptance_criteria_raw=story.get("acceptance_criteria_raw", ""),
            ...
            fix_versions=story.get("fixVersions", []),
            requirement_status=story.get("requirement_status", {}),
            references_json=story.get("references", {}),
